# Generated by Django 4.2.8 on 2024-04-09 19:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('map_rule', models.TextField(db_column='mapRule', default='')),
                ('map_advice', models.TextField(db_column='mapAdvice', default='')),
                ('map_target', models.TextField(db_column='mapTarget', db_index=True, default='')),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('referenced_component_name', models.TextField(db_column='referencedComponentName', default='')),
                ('map_target_name', models.TextField(db_column='mapTargetName', db_index=True, default='')),
                ('map_category_name', models.TextField(db_column='mapCategoryName', default='')),
